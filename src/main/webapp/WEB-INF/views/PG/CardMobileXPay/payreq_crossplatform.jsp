...
<%
	...
	* 가상계좌(무통장) 결제 연동을 하시는 경우 아래 LGD_CASNOTEURL 을 설정하여 주시기 바랍니다.
 	*/
	String LGD_CASNOTEURL		= "https://rhkdqhrehddl.tk/PG/CardMobileXPay/cas_noteurl.do";

    /*
   	* LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
   	*/
	String LGD_RETURNURL		= "https://rhkdqhrehddl.tk/PG/CardMobileXPay/returnurl.do";// FOR MANUAL
	 ...
	 */
	String LGD_CARDTYPE			= request.getParameter("LGD_CARDTYPE");					// 카드선택
	String LGD_INSTALL			= request.getParameter("LGD_INSTALL");					// 할부개월
	String LGD_NOINT			= request.getParameter("LGD_NOINT");					// 무이자여부
	...
	String LGD_CANCELURL		= request.getParameter("LGD_CANCELURL");				// 안심클릭 취소 URL
	String LGD_SELF_CUSTOM		= request.getParameter("LGD_SELF_CUSTOM");				// 신용카드선택페이지 스킵관련 파라미터
	//-끝
	...
	*/
	 ...
	 * 신용카드 결제요청시에만 추가 해 주세요.
	 */
	payReqMap.put("LGD_CARDTYPE"				, LGD_CARDTYPE );						// 카드선택
	payReqMap.put("LGD_INSTALL"					, LGD_INSTALL );						// 할부개월
