	     ...
	     */
	     ...
	     if ( xpay.TX() ) {
	         ...
	         if( "0000".equals( xpay.m_szResCode ) ) {
	            ...
	            sbuf.append(xpay.Response("LGD_MID",0));
	            sbuf.append(xpay.Response("LGD_TID",0));
	            sbuf.append(Config.value(xpay.Response("LGD_MID",0)));    
	        	...
	        	for (int i=0 ; i < msgStr.length ; i++) {
	         	...
	         	if("SC0010".equals(xpay.Response("LGD_PAYTYPE",0))){		             		         	
		         	//신용카드 매출전표 출력 링크
					out.println("<a href='javascript:showReceiptByTID(\"" + xpay.Response("LGD_MID",0) + "\",\"" + xpay.Response("LGD_TID",0) +  "\", \"" + authdata + "\");'>매출전표 출력</a>");
	         	} else if("SC0030".equals(xpay.Response("LGD_PAYTYPE",0))){
	         		//현금영수증 출력 링크
					out.println("<a href='javascript:showCashReceipts(\"" + xpay.Response("LGD_MID",0) + "\",\"" + xpay.Response("LGD_OID",0) +  "\", \"\",\"" + "BANK" +  "\", \"" + request.getParameter("CST_PLATFORM") + "\");'>현금영수증 출력</a>");
	         	}
