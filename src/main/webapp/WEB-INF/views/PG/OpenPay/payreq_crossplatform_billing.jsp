...
function launchCrossPlatform()
{
	...
	{
		out.println("lgdwin = openXpay(document.getElementById('LGD_PAYINFO'),'"+CST_PLATFORM+"','"+LGD_WINDOW_TYPE+"',null,'','');");
	}
	else
	{
		out.println("lgdwin = openXpay(document.getElementById('LGD_PAYINFO'),'"+CST_PLATFORM+"','"+LGD_WINDOW_TYPE+"',null,'"+iPopUpWinX+"','"+iPopUpWinY+"');");
	}
	%>
}
/*
...
function payment_return() 
{
	...
	if (fDoc.document.getElementById('LGD_RESPCODE').value == "0000") 
	{
			...
			document.getElementById("LGD_PAYINFO").action = "payres_billing.do";
...
<body>
<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="payres_billing.do">
<table>
    <tr>
        <td>구매자 이름 </td>
        <td><%=LGD_BUYER%></td>
